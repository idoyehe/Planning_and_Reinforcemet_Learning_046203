...
def test_16_moves():
    ...
    assert plan["actions"] == 'u l d r u r d l l u r d r u l d'
...
def test_16_2_moves():
    ...
    plan = analyze_plan(plan)
    assert plan["length"] == 16
    assert plan["actions"] == 'u r d l u l d r r u l d l u r d'
...
def test_28_moves():
    ...
    assert plan["actions"] == 'd l u r r d l u u r d d l u u l d d r u u l d r r u l d'
